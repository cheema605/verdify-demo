...
const Dashboard: React.FC<DashboardProps> = ({ onNewAnalysis, onViewNotifications }) => {
  ...
  const filteredProjects = currentWorkspace ? getProjectsByWorkspace(currentWorkspace.id) : [];
        ...
        <div className="space-y-6">
          <Card className="p-6">
            ...
            <div className="space-y-4">
              {generateNotifications(filteredProjects).slice(0, 3).map((alert) => (
                <div
                  key={alert.id}
            ...
            <Button variant="ghost" className="w-full mt-4 text-xs font-bold text-indigo-600" onClick={onViewNotifications}>View All Notifications</Button>
          </Card>
